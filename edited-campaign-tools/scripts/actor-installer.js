...
function pcActors() {
  return [
    pc({
      ...
      biography: `<h2>Edward Dravin — William's PC</h2>${paragraph("A youthful middle-aged aasimar, son of Persephone, with dark brown hair dusted early with grey. Cold but fair and lawfully tricky, he travels between an affluent summer home and winter home. His custom sheet toggle follows Persephone between Olympus and Hades, changing his appearance and prepared spell loadout while preserving hit points, inventory, and spent spell slots.")}`,
      items: [
